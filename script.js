...
//total score after hold
btnHold.addEventListener('click',function()
{
    if(playing)
    {
        //add curr score to active player score
        scores[activePlayer] += currScore;//scores[1]+=currscore
        //displaying total till hold
